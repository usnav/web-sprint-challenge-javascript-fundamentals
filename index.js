...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: According to the rule of closures, where an inner function reaches out of its scope 
// to grab a variable defined in an outer function, nestedFunction is able to reach outside of its scope and access the variable internal.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(arraycb){
      const lower = arraycb.map(function(item) {
  ...
  */
  ...
  function USApop(arraycb){
    const totalPop = arraycb.reduce(function(accumulator, item){
